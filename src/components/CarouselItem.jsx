	...
	return (
		<div className="p-4 mb-6 snap-center min-w-5/6 md:min-w-9/19 lg:min-w-5/16 sm:mb-0">
			<div className="h-64 overflow-hidden rounded-lg">
				<img className="object-cover object-center w-full h-full" src={image} alt="content" />
			</div>
			...
			<Link to="/lugares/pripyat" className="inline-flex items-center mt-3 text-red-500">
				Ver Más
