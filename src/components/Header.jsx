					...
					<div className="md:flex md:items-center md:justify-between">
						...
						<div className="flex-1 md:flex md:items-center md:justify-between">
							...
							<div className="flex items-center mt-4 md:mt-0">
								<button type="button" id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation" className="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
									<div className="w-8 h-8 overflow-hidden border-2 rounded-full border-zinc-400">
										<Image className="object-cover w-full h-full" src={oscar} alt="avatar" />
									</div>

									<h3 className="mx-2 text-sm font-medium text-zinc-700 dark:text-zinc-200 md:hidden">Oscar Isaac</h3>
								</button>
							</div>

							{/* <!-- Dropdown menu --> */}
							<div id="dropdownInformation" className="z-10 hidden w-auto bg-white divide-y rounded shadow divide-zinc-100 dark:bg-zinc-800 dark:divide-zinc-600">
								<div className="px-4 py-3 text-sm text-zinc-900 dark:text-white">
									<div>Oscar Isaac</div>
									<div className="font-medium truncate">name@flowbite.com</div>
								</div>
								<ul className="py-1 text-sm text-zinc-700 dark:text-zinc-200" aria-labelledby="dropdownInformationButton">
									<li>
										<Link href="/" className="flex items-center px-4 py-2 transition-colors duration-200 transform hover:bg-zinc-100 dark:hover:bg-zinc-600 dark:hover:text-white">
											<>
									...
									<li>
										<Link href="/admin" className="flex items-center px-4 py-2 transition-colors duration-200 transform hover:bg-zinc-100 dark:hover:bg-zinc-600 dark:hover:text-white">
											<>
												<svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
													<path
														strokeLinecap="round"
