			...
			<div className="px-5 py-12 mx-auto">
				<div className="flex flex-col">
					...
					<div className="flex flex-col flex-wrap py-6 mb-12 sm:flex-row">
						<h1 className="mb-2 text-3xl font-bold text-zinc-800 dark:text-white sm:w-2/5 font-display title-font sm:mb-0">{title}</h1>
						<p className="pl-0 text-base leading-relaxed sm:w-3/5 sm:pl-10">{description}</p>
					</div>
				</div>
