...
const Home = () => {
	return (
		<>
			...
			<Carousel title="Lugares Más Populares" description="Conoce los lugares más populares de los últimos años visitados únicamente por aquellos que son más atrevidos y audaces." />
