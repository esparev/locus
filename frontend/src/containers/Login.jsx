...
const Login = () => {
  const background =
    'https://images.unsplash.com/photo-1517061093373-db94568ace5e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80';
  return (
    <div className='flex items-center h-screen bg-zinc-900 pattern'>
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-zinc-800 lg:h-auto lg:max-w-4xl'>
        ...
        <div className='flex flex-col justify-center w-full px-6 py-8 md:px-8 lg:w-1/2'>
          <h2 className='text-2xl font-black text-center uppercase font-display text-zinc-700 dark:text-white'>
            Locus
          </h2>

          <p className='text-xl text-center text-zinc-600 dark:text-zinc-200'>
            ¡Bienvenido de nuevo!
          </p>

          <div className='mt-4'>
            <label
              className='block mb-2 text-sm font-medium text-zinc-600 dark:text-zinc-200'
          ...
          <div className='mt-4'>
            <div className='flex justify-between'>
              ...
              <a
                href='#'
                className='text-xs text-zinc-500 hover:underline dark:text-zinc-300'
              >
